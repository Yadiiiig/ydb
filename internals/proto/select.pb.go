...
type SelectValues struct {
	...
	Values []*SValues `protobuf:"bytes,3,rep,name=Values,proto3" json:"Values,omitempty"`
}
...
func (x *SelectValues) GetValues() []*SValues {
	if x != nil {
		return x.Values
	}
	return nil
...
func (x *SValues) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SValues) ProtoMessage() {}

func (x *SValues) ProtoReflect() protoreflect.Message {
	mi := &file_internals_proto_select_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *SValues) GetOperator() string {
	if x != nil {
		return x.Operator
	}
	return ""
...
func (x *SValues) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
var file_internals_proto_select_proto_rawDesc = []byte{
	...
	0x6f, 0x2f, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5e,
	...
	0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x12, 0x20, 0x0a, 0x06,
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x08, 0x2e, 0x53,
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x52, 0x06, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0x4d,
	0x0a, 0x07, 0x53, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x12, 0x10, 0x0a, 0x03, 0x52, 0x6f, 0x77,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x52, 0x6f, 0x77, 0x12, 0x1a, 0x0a, 0x08, 0x4f,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x28, 0x0a,
	...
	0x06, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x39, 0x0a, 0x06, 0x53, 0x65, 0x6c, 0x65, 0x63,
	0x74, 0x12, 0x2f, 0x0a, 0x0b, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x51, 0x75, 0x65, 0x72, 0x79,
	0x12, 0x0d, 0x2e, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x1a,
	0x0f, 0x2e, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
