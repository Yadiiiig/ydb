...
type UpdateClient interface {
	UpdateQuery(ctx context.Context, in *UpdateValues, opts ...grpc.CallOption) (*UpdateResponse, error)
}
...
func (c *updateClient) UpdateQuery(ctx context.Context, in *UpdateValues, opts ...grpc.CallOption) (*UpdateResponse, error) {
	out := new(UpdateResponse)
	err := c.cc.Invoke(ctx, "/Update/UpdateQuery", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UpdateServer interface {
	UpdateQuery(context.Context, *UpdateValues) (*UpdateResponse, error)
...
func (UnimplementedUpdateServer) UpdateQuery(context.Context, *UpdateValues) (*UpdateResponse, error) {
...
func _Update_UpdateQuery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateValues)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UpdateServer).UpdateQuery(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Update/UpdateQuery",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UpdateServer).UpdateQuery(ctx, req.(*UpdateValues))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Update_UpdateQuery_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "internals/proto/update.proto",
}
